...
Требуется Android 8.0 или новее (API 26 — из-за `java.time`). Размер — 31 КБ,
...
| Файл | Назначение |
| --- | --- |
| `app/src/main/java/ru/depositcalc/DepositCalculator.java` | расчёты: проценты, капитализация, пополнения, налог, XIRR |
