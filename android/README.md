...
| Форма ввода | После расчёта |
| --- | --- |
| ![Условия вклада](screenshots/1-условия.png) | ![Результат](screenshots/2-результат.png) |
...
кадра: пустую форму и экран после расчёта. Готовые снимки лежат в
